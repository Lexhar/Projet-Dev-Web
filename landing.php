...
// si la session n'existe pas, c'est-à-dire si l'utilisateur n'est pas connecté, on redirige vers la page d'index
...
$utilisateurs = $jsonData['utilisateurs'];

// Rechercher l'utilisateur actuel par son token
$currentUser = null;
foreach ($utilisateurs as $user) {
    if ($user['token'] === $_SESSION['user']) {
        $currentUser = $user;
        break;
    }
}

// Si l'utilisateur actuel n'est pas trouvé, on redirige vers la page d'index
if (!$currentUser) {
    header('Location:index.php');
    die();
}
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="text-center">
                <h1 class="p-5">Bonjour <?php echo $currentUser['pseudo']; ?> !</h1>
                <hr />
